...
- 다른 날짜를 선택하면 해당 날짜 루틴은 보여주되, `운동 시작`과 `운동 전 몸무게 저장`은 비활성화했습니다.
...
- 달력 패널과 오늘 운동 패널이 같은 행에서 높이를 맞추도록 레이아웃을 조정했습니다.
- `운동 전 몸무게 기록`은 루틴 카드 하단으로 옮겼고, 오늘 날짜에서만 저장되도록 했습니다.
